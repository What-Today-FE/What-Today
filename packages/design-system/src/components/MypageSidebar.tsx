...
export default function MypageSidebar({ profileImgUrl, onClick }: MypageSidebarProps) {
  ...
  return (
    <nav className='flex grow flex-col items-center gap-24 rounded-xl border border-gray-50 bg-white px-14 pt-24 pb-12 shadow-[0px_4px_24px_rgba(156,180,202,0.2)] md:max-w-290'>
      {profileImgUrl ? (
